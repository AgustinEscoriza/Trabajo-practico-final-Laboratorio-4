                              ...
                              foreach($cinemaList as $cinema)
                              {
                                   ?>
                                        <tr>
                                             ...
                                             <button type="submit" name="idCinema" class="btn btn-dark ml-auto " value="<?php echo $cinema->getId(); ?>" onclick="submitForm('<?php echo FRONT_ROOT ?>Auditorium/ShowListView')"> Show Auditoriums </button>
